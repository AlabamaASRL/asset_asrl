...
if __name__ == "__main__":
    ...
    phase.addLUVarBoundNEW("Path","h",hmin,hmax)
    phase.addLUVarBoundNEW("Path","v",vmin,vmax)
    phase.addLUVarBoundNEW("Path","fpa",fpamin,fpamax)
    phase.addLowerVarBoundNEW("Last","mass",massmin)
    phase.addLUVarBoundNEW("Path","alpha",alphamin,alphamax)
    phase.addBoundaryValueNEW("Last",["h","v","fpa"],[htf,vtf,fpatf])
    phase.addDeltaTimeObjectiveNEW(1.0)
