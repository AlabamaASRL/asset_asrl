...
struct FunctionRegistry {
  ...
  FunctionRegistry(py::module& m)
      : mod(m),
        vfmod(m.def_submodule("VectorFunctions", "SubModule Containing Vector and Scalar Function Types and Functions")),
        ocmod(m.def_submodule("OptimalControl", "SubModule Containing Optimal Control ODEs, Phases, and Utilities")),
  ...
  py::module& getVectorFunctionsModule() { return this->vfmod; }
  py::module& getOptimalControlModule() { return this->ocmod; }
  py::module& getSolversModule() { return this->solmod; }
