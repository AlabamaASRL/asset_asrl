...
decltype(auto) operator*(const DenseFunctionBase<Derived, IR, OR>& func,
                         StaticScaleBase<VALUE> s) {
  return StaticScaled<Derived, VALUE>(func.derived());
}

template <class Derived, int IR, int OR>
decltype(auto) operator*(double s,
...
decltype(auto) operator*(const RowScaled<Derived>& func,
                         const Eigen::MatrixBase<OutType>& s) {
  return RowScaled<Derived>(func.RowScaled_func,
                            func.RowScale_values.cwiseProduct(s));
}
template <class Derived, class OutType>
decltype(auto) operator*(const Eigen::MatrixBase<OutType>& s,
                         const RowScaled<Derived>& func) {
  return RowScaled<Derived>(func.RowScaled_func,
                            func.RowScale_values.cwiseProduct(s));
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
decltype(auto) operator/(double s,
                         const DenseFunctionBase<Derived, IR, 1>& func) {
  return Scaled<CwiseInverse<Derived>>(CwiseInverse<Derived>(func.derived()),
                                       s);
}
...
auto operator+(const GenericFunction<IR, OR>& func,
               const Eigen::MatrixBase<OutType>& s) {
...
template <int IR, int OR, class OutType>
auto operator+(const Eigen::MatrixBase<OutType>& s,
               const GenericFunction<IR, OR>& func) {
  return FunctionPlusVector<GenericFunction<IR, OR>>(func, s);
}
...
decltype(auto) operator-(const Eigen::MatrixBase<OutType>& s,
                         const DenseFunctionBase<Derived, IR, OR>& func) {
  return FunctionPlusVector<Scaled<Derived>>(
      Scaled<Derived>(func.derived(), -1.0), s);
}

template <class Derived, int IR>
decltype(auto) operator+(const DenseFunctionBase<Derived, IR, 1>& func,
                         double s) {
  Vector1<double> st;
  st[0] = s;
...
decltype(auto) operator-(double s,
  ...
  return FunctionPlusVector<Scaled<Derived>>(
      Scaled<Derived>(func.derived(), -1.0), st);
}
...
decltype(auto) operator+(const DenseFunctionBase<Func3, IR, OR>& f2,
  ...
  return MultiFunctionSum<Func1, Func2, Func3>(f1.func1, f1.func2,
                                               f2.derived());
}
...
template <class Func1, int IR, class Func2>
auto operator <=(const DenseFunctionBase<Func1, IR, 1>& lhs, const DenseFunctionBase<Func2, IR, 1>& rhs) {
    return ConditionalStatement<Func1, Func2>(lhs.derived(), ConditionalFlags::LessThanEqualToFlag, rhs.derived());
}
template <class Func1, int IR, class Func2>
auto operator >(const DenseFunctionBase<Func1, IR, 1>& lhs, const DenseFunctionBase<Func2, IR, 1>& rhs) {
    return ConditionalStatement<Func1, Func2>(lhs.derived(), ConditionalFlags::GreaterThanFlag, rhs.derived());
}
template <class Func1, int IR, class Func2>
auto operator >=(const DenseFunctionBase<Func1, IR, 1>& lhs, const DenseFunctionBase<Func2, IR, 1>& rhs) {
    return ConditionalStatement<Func1, Func2>(lhs.derived(), ConditionalFlags::GreaterThanEqualToFlag, rhs.derived());
}
template <class Func1, int IR, class Func2>
auto operator ==(const DenseFunctionBase<Func1, IR, 1>& lhs, const DenseFunctionBase<Func2, IR, 1>& rhs) {
...
auto operator <(const DenseFunctionBase<Func1, IR, 1>& lhs, double rhsv) {
    ...
    return ConditionalStatement<Func1, Constant<IR, 1>>(lhs.derived(), ConditionalFlags::LessThanFlag, rhs.derived());
}
template <class Func1, int IR>
auto operator <=(const DenseFunctionBase<Func1, IR, 1>& lhs, double rhsv) {
    Vector1<double> tmp;
    tmp[0] = rhsv;
    Constant<IR, 1> rhs(lhs.IRows(), tmp);
    return ConditionalStatement<Func1, Constant<IR, 1>>(lhs.derived(), ConditionalFlags::LessThanEqualToFlag, rhs.derived());
}
template <class Func1, int IR>
auto operator >(const DenseFunctionBase<Func1, IR, 1>& lhs, double rhsv) {
    Vector1<double> tmp;
    tmp[0] = rhsv;
    Constant<IR, 1> rhs(lhs.IRows(), tmp);
    return ConditionalStatement<Func1, Constant<IR, 1>>(lhs.derived(), ConditionalFlags::GreaterThanFlag, rhs.derived());
}
template <class Func1, int IR>
auto operator >=(const DenseFunctionBase<Func1, IR, 1>& lhs, double rhsv) {
    Vector1<double> tmp;
    tmp[0] = rhsv;
    Constant<IR, 1> rhs(lhs.IRows(), tmp);
    return ConditionalStatement<Func1, Constant<IR, 1>>(lhs.derived(), ConditionalFlags::GreaterThanEqualToFlag, rhs.derived());
}
template <class Func1, int IR>
auto operator ==(const DenseFunctionBase<Func1, IR, 1>& lhs, double rhsv) {
    Vector1<double> tmp;
    tmp[0] = rhsv;
    Constant<IR, 1> rhs(lhs.IRows(), tmp);
    return ConditionalStatement<Func1, Constant<IR, 1>>(lhs.derived(), ConditionalFlags::EqualToFlag, rhs.derived());
}
...
template <class M1, class M2, int M1Rows, int M1Cols_M2Rows, int M2Cols,
          int M1Major, int M2Major>
decltype(auto) operator*(
    const MatrixFunctionView<M1, M1Rows, M1Cols_M2Rows, M1Major>& m1,
