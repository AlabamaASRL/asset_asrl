...
struct PaddedOutput : VectorFunction<PaddedOutput<Func, UP, LP>, Func::IRC,
                                     SZ_SUM<LP, UP, Func::ORC>::value>,
                      UpperPadHolder<UP> {
  using Base = VectorFunction<PaddedOutput<Func, UP, LP>, Func::IRC,
                              SZ_SUM<LP, UP, Func::ORC>::value>;
  ...
  PaddedOutput(Func f, int upad, int lpad)
      : UpperPadHolder<UP>(upad), func(std::move(f)) {
    this->setIORows(this->func.IRows(),
                    this->func.ORows() + upad + lpad);
  ...
  inline void compute_impl(ConstVectorBaseRef<InType> x,
    ...
    this->func.compute(x, fx.template segment<Func::ORC>(
                                     this->UPad, this->func.ORows()));
  }
  ...
  inline void compute_jacobian_impl(ConstVectorBaseRef<InType> x,
    ...
    this->func.compute_jacobian(
        ...
        jx.template middleRows<Func::ORC>(this->UPad,
                                          this->func.ORows()));
  }
  ...
  inline void compute_jacobian_adjointgradient_adjointhessian_impl(
    ...
    this->func.compute_jacobian_adjointgradient_adjointhessian(
        ...
        jx.template middleRows<Func::ORC>(this->UPad,
                                          this->func.ORows()),
        adjgrad, adjhess,
        adjvars.template segment<Func::ORC>(this->UPad,
                                            this->func.ORows()));
  }
  ...
  inline void right_jacobian_product(
    ...
    if constexpr (Is_EigenDiagonalMatrix<Left>::value) {
      ...
      Base::right_jacobian_product(target_, left_ref, right_ref, assign,
                                   aliased);
    } else {
      ...
      this->func.right_jacobian_product(
          target_,
          left_ref.template middleCols<Func::ORC>(this->UPad,
                                                  this->func.ORows()),
          right_ref.template middleRows<Func::ORC>(this->UPad,
                                                   this->func.ORows()),
          assign, aliased);
    }
  }
  ...
  inline void accumulate_jacobian(ConstMatrixBaseRef<Target> target_,
    ...
    this->func.accumulate_jacobian(
        target.template middleRows<Func::ORC>(this->UPad,
                                              this->func.ORows()),
        right.template middleRows<Func::ORC>(this->UPad,
                                             this->func.ORows()),
        assign);
  }
  template <class Target, class JacType, class Assignment>
  ...
  inline void scale_jacobian(ConstMatrixBaseRef<Target> target_,
                             Scalar s) const {
    MatrixBaseRef<Target> target = target_.const_cast_derived();
    this->func.scale_jacobian(target.template middleRows<Func::ORC>(
                                         this->UPad, this->func.ORows()),
                                     s);
  }
  template <class Target, class Scalar>
