...
struct CwiseFunctionProduct
    : CwiseFunctionProduct_Impl<CwiseFunctionProduct<Func1, Func2>, Func1,
                                Func2> {
  using Base = CwiseFunctionProduct_Impl<CwiseFunctionProduct<Func1, Func2>,
                                         Func1, Func2>;
...
struct CwiseFunctionProduct_Impl
  ...
  CwiseFunctionProduct_Impl(Func1 f1, Func2 f2) : func1(std::move(f1)), func2(std::move(f2)) {
    ...
    if (this->func1.ORows() != this->func2.ORows()) {
      std::cout << "User Input Error in CwiseFunctionProduct:" << this->name()
                << std::endl;
      std::cout << "	Output Size of Func1 ( " << this->func1.name()
                << " ) does not match Output Size of Func2 ( "
                << this->func2.name() << " )" << std::endl;
  ...
  inline void compute_jacobian_impl(ConstVectorBaseRef<InType> x,
    ...
    auto Impl = [&](auto& fx2, auto& jx2) {
        ...
        this->func1.right_jacobian_product(jx, fx2.asDiagonal(), jx,
            DirectAssignment(),
            std::bool_constant<true>());
        this->func2.right_jacobian_product(jx, fx.asDiagonal(), jx2,
  ...
  inline void compute_jacobian_adjointgradient_adjointhessian_impl(
    ...
    auto Impl = [&](auto& fx2, auto & jx2,auto & gx2,auto & hx2, auto & adjprod,auto & jttemp) {
        ...
        this->func2.right_jacobian_product(jttemp, adjvars.asDiagonal(), jx2,
            DirectAssignment(),
            std::bool_constant<false>());
        this->func1.right_jacobian_product(hx2, jttemp.transpose(), jx,
            PlusEqualsAssignment(),
            std::bool_constant<false>());
