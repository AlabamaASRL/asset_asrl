...
struct PyVectorFunction
    : VectorFunction<PyVectorFunction<IRR, ORR>, IRR, ORR, FDiffFwd, FDiffFwd> {
    using Base =
        VectorFunction<PyVectorFunction<IRR, ORR>, IRR, ORR, FDiffFwd, FDiffFwd>;
...
template <int IRR, int ORR>
struct NumbaVectorFunction : VectorFunction<NumbaVectorFunction<IRR, ORR>, IRR,
                                            ORR, FDiffFwd, FDiffFwd> {
  using Base = VectorFunction<NumbaVectorFunction<IRR, ORR>, IRR, ORR, FDiffFwd,
                              FDiffFwd>;
  ...
  NumbaVectorFunction(int irr, const FType& f, double js, double hs)
      : NumbaVectorFunction(irr, ORR, f, js, hs) {}
  NumbaVectorFunction(int irr, const FType& f)
      : NumbaVectorFunction(irr, ORR, f) {}
