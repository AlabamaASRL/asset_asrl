...
namespace ASSET {
    ...
    struct FunctionImagProduct
        : FunctionVectorProduct_Impl<FunctionImagProduct<Func1, Func2>, Func1,
        Func2, 2> {
        using Base = FunctionVectorProduct_Impl<FunctionImagProduct<Func1, Func2>,
            Func1, Func2, 2>;
        using Base::Base;
    ...
    struct FunctionCrossProduct
        : FunctionVectorProduct_Impl<FunctionCrossProduct<Func1, Func2>, Func1,
        Func2,3> {
        using Base = FunctionVectorProduct_Impl<FunctionCrossProduct<Func1, Func2>,
            Func1, Func2,3>;
        using Base::Base;
        DENSE_FUNCTION_BASE_TYPES(Base);
    };
    ...
    struct FunctionQuatProduct
        : FunctionVectorProduct_Impl<FunctionQuatProduct<Func1, Func2>, Func1,
        Func2, 4> {
        using Base = FunctionVectorProduct_Impl<FunctionQuatProduct<Func1, Func2>,
            Func1, Func2, 4>;
        using Base::Base;
        DENSE_FUNCTION_BASE_TYPES(Base);
    };
    ...
    struct CrossProduct : VectorFunction<CrossProduct, 6, 3> {
        ...
        static void cprodmat(const Eigen::MatrixBase<Source>& x,
            Eigen::MatrixBase<Target> const& m_, Scalar2 sign) {
        ...
        FunctionVectorProduct_Impl(Func1 f1, Func2 f2) : func1(std::move(f1)), func2(std::move(f2)) {
            ...
            if (this->func1.IRows() != this->func2.IRows()) {
                ...
                fmt::print(fmt::fg(fmt::color::red),
                    ...
                    this->func1.IRows(), this->func2.IRows(),Vsize);
                throw std::invalid_argument("");
        ...
        inline void compute_jacobian_impl(ConstVectorBaseRef<InType> x,
            ...
            if constexpr (IsSegmentOp) {
                ...
                auto Impl = [&](auto& jx1, auto& jx2) {
                    ...
                    this->func1.right_jacobian_product(jx, pm1, jx1,
                        DirectAssignment(),
                        std::bool_constant<false>());
                    this->func2.right_jacobian_product(jx, pm2, jx2,
        ...
        template <class InType, class OutType, class JacType, class AdjGradType,
            ...
            auto Impl = [&](auto& jx1, auto& jx2, auto& jttemp, auto& gx2, auto& hx2) {
                ...
                this->func2.right_jacobian_product(
                    jttemp, lpm2, jx2, DirectAssignment(),
                    std::bool_constant<false>());
                ...
                this->func1.right_jacobian_product(jx, pm1, jx1,
                    ...
                    std::bool_constant<false>());
                this->func2.right_jacobian_product(
                    jx, pm2, jx2, PlusEqualsAssignment(),
                    std::bool_constant<false>());
            };
