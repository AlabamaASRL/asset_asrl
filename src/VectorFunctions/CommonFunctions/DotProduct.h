...
template <class Derived, class Func1, class Func2>
struct FunctionDotProduct_Impl
    : VectorFunction<Derived, SZ_MAX<Func1::IRC, Func2::IRC>::value, 1> {
  using Base =
      VectorFunction<Derived, SZ_MAX<Func1::IRC, Func2::IRC>::value, 1>;
  DENSE_FUNCTION_BASE_TYPES(Base);
  ...
  using INPUT_DOMAIN = CompositeDomain<
      Base::IRC, 
  ...
  inline void compute_impl(ConstVectorBaseRef<InType> x,
    ...
    if constexpr (IsSegmentOp) {
      fx[0] = x.template segment<Func1::ORC>(this->func1.SegStart,
                                             this->func1.ORows())
                  .dot(x.template segment<Func2::ORC>(this->func2.SegStart,
                                                      this->func2.ORows()));
    }
    else {
  ...
  inline void compute_jacobian_impl(ConstVectorBaseRef<InType> x,
    ...
    if constexpr (IsSegmentOp) {
      ...
      jx.template block<1, Func1::ORC>(0, this->func1.SegStart, 1,
                                       this->func1.ORows()) +=
          x.template segment<Func2::ORC>(this->func2.SegStart,
                                         this->func2.ORows())
              .transpose();

      jx.template block<1, Func2::ORC>(0, this->func2.SegStart, 1,
                                       this->func2.ORows()) +=
          x.template segment<Func1::ORC>(this->func1.SegStart,
                                         this->func1.ORows())
              .transpose();
        ...
        auto Impl = [&](auto& fx1, auto& fx2, auto& jx1, auto& jx2) {
            ...
            this->func1.right_jacobian_product(jx_, fx2.transpose(), jx1,
                DirectAssignment(),
                std::bool_constant<false>());
            this->func2.right_jacobian_product(jx_, fx1.transpose(), jx2,
  ...
  inline void compute_jacobian_adjointgradient_adjointhessian_impl(
    ...
    if constexpr (IsSegmentOp) {
      ...
      adjgrad.template segment<Func1::ORC>(this->func1.SegStart,
                                           this->func1.ORows()) +=
          x.template segment<Func2::ORC>(this->func2.SegStart,
                                         this->func2.ORows()) *
          adjvars[0];

      adjgrad.template segment<Func2::ORC>(this->func2.SegStart,
                                           this->func2.ORows()) +=
          x.template segment<Func1::ORC>(this->func1.SegStart,
                                         this->func1.ORows()) *
          adjvars[0];
      ...
      for (int i = 0; i < this->func1.ORows(); i++) {
        adjhess(this->func1.SegStart + i, this->func2.SegStart + i) +=
            adjvars[0];
        adjhess(this->func2.SegStart + i, this->func1.SegStart + i) +=
            adjvars[0];
      }
        ...
        auto Impl = [&](auto& fx1, auto& fx2, auto& jx1, auto& jx2, auto& gx2,
            auto& hx2, auto& adjtemp) {
                ...
                this->func1.right_jacobian_product(hx2, jx2.transpose(), jx1,
                    DirectAssignment(),
                    std::bool_constant<false>());
                ...
                if constexpr (Func1::InputIsDynamic) {
                    ...
                    ASSET::constexpr_for_loop(
                        ...
                        std::integral_constant<int, sds>(), [&](auto i) {
                            constexpr int start =
                                Func1::INPUT_DOMAIN::SubDomains[i.value][0];
                            constexpr int size =
                                Func1::INPUT_DOMAIN::SubDomains[i.value][1];
