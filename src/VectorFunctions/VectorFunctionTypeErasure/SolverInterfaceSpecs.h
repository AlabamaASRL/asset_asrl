...
File Description: Defines the rubber_types compatible type erasure specs (SolverConstraintSpec,SolverObjectiveSpec) 
and objects (ConstraintInterface,ObjectiveInterface) that enable vector functions
to interface with PSIOPT and NonLinearProgram.
...
/*
* Spec for vector function that can be used as a constraint inside of PSIOPT. Erases all .constraints_xxx methods
* as well as the function specific methods for requesting and allocating space from the solver. 
*/
struct SolverConstraintSpec {
  ...
  struct Concept {  // abstract base class for model.
    ...
    virtual void constraints_adjointgradient(
        const Eigen::Ref<const Eigen::VectorXd>& X,
        const Eigen::Ref<const Eigen::VectorXd>& L,
        Eigen::Ref<Eigen::VectorXd> FX, Eigen::Ref<Eigen::VectorXd> AGX,
        const SolverIndexingData& data) const = 0;

    virtual void constraints_jacobian(
        const Eigen::Ref<const Eigen::VectorXd>& X,
        Eigen::Ref<Eigen::VectorXd> FX,
    ...
    virtual void getKKTSpace(Eigen::Ref<Eigen::VectorXi> KKTrows,
                             Eigen::Ref<Eigen::VectorXi> KKTcols, int& freeloc,
  ...
  struct Model : public Holder, public virtual Concept {
    ...
    virtual void constraints_adjointgradient(
        ...
        Eigen::Ref<Eigen::VectorXd> FX, Eigen::Ref<Eigen::VectorXd> AGX,
        const SolverIndexingData& data) const override {
      return rubber_types::model_get(*this).constraints_adjointgradient(
          X, L, FX, AGX, data);
    }
    ...
    virtual void constraints_jacobian_adjointgradient(
      ...
      return rubber_types::model_get(*this)
          .constraints_jacobian_adjointgradient(
  ...
  struct ExternalInterface : public Container {
    ...
    void constraints_adjointgradient(const Eigen::Ref<const Eigen::VectorXd>& X,
                                     ...
                                     const SolverIndexingData& data) const {
      return rubber_types::interface_get(*this).constraints_adjointgradient(
          X, L, FX, AGX, data);
    }
...
/*
* Spec for scalar vector functions that can be used as an objective inside of PSIOPT. Erases all .objective_xxx methods.
*/
struct SolverObjectiveSpec {
  ...
  struct Concept {  // abstract base class for model.
    ...
    virtual void objective_gradient_hessian(
        double ObjScale, const Eigen::Ref<const Eigen::VectorXd>& X,
        double& Val, Eigen::Ref<Eigen::VectorXd> GX,
        Eigen::SparseMatrix<double, Eigen::RowMajor>& KKTmat,
        Eigen::Ref<Eigen::VectorXi> KKTLocations,
        Eigen::Ref<Eigen::VectorXi> KKTClashes,
  ...
  struct Model : public Holder, public virtual Concept {
    ...
    virtual void objective_gradient(
        double ObjScale, const Eigen::Ref<const Eigen::VectorXd>& X,
        double& Val, Eigen::Ref<Eigen::VectorXd> GX,
        const SolverIndexingData& data) const override {
      return rubber_types::model_get(*this).objective_gradient(ObjScale, X, Val,
                                                               GX, data);
    }
    ...
    virtual void objective_gradient_hessian(
      ...
      return rubber_types::model_get(*this).objective_gradient_hessian(
          ObjScale, X, Val, GX, KKTmat, KKTLocations, KKTClashes, KKTLocks,
          data);
    }
  };
  //////////////////////////////////////////////////////////////////////////////
  ...
  struct ExternalInterface : public Container {
    ...
    void objective(double ObjScale, const Eigen::Ref<const Eigen::VectorXd>& X,
      ...
      return rubber_types::interface_get(*this).objective(ObjScale, X, Val,
                                                          data);
    }
    ...
    void objective_gradient(double ObjScale,
                            ...
                            double& Val, Eigen::Ref<Eigen::VectorXd> GX,
                            const SolverIndexingData& data) const {
      return rubber_types::interface_get(*this).objective_gradient(
          ObjScale, X, Val, GX, data);
    }

    void objective_gradient_hessian(
        double ObjScale, const Eigen::Ref<const Eigen::VectorXd>& X,
        double& Val, Eigen::Ref<Eigen::VectorXd> GX,
        Eigen::SparseMatrix<double, Eigen::RowMajor>& KKTmat,
        Eigen::Ref<Eigen::VectorXi> KKTLocations,
...
struct SolverInterfaceSelector<IR, 1> {
    using type =
        rubber_types::MergeSpecs<SolverConstraintSpec, SolverObjectiveSpec>;
};
...
*/
struct ConstraintInterface
    : rubber_types::TypeErasure<SolverConstraintSpec, SizableSpec,
...
struct ObjectiveInterface
    : rubber_types::TypeErasure<
          SolverConstraintSpec, SolverObjectiveSpec, SizableSpec,
          DeepCopySpecs<ObjectiveInterface, ConstraintInterface>> {
  using Base = rubber_types::TypeErasure<
      SolverConstraintSpec, SolverObjectiveSpec, SizableSpec,
      DeepCopySpecs<ObjectiveInterface, ConstraintInterface>>;
