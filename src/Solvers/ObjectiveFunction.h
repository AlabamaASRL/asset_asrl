...
struct ObjectiveFunction : SolverFunctionBase<ObjectiveInterface> {
  ...
  ObjectiveFunction(const ObjectiveInterface& f,
  ...
  */
  ...
  vector function.
  */
  void objective(double ObjScale, ConstEigenRef<Eigen::VectorXd> X,
                 double& Val) const {
  ...
  vector function.
  */
  void objective_gradient(double ObjScale, ConstEigenRef<Eigen::VectorXd> X,
                          double& Val, EigenRef<Eigen::VectorXd> GX) const {
  ...
  */
  void objective_gradient_hessian(
      double ObjScale, ConstEigenRef<Eigen::VectorXd> X, double& Val,
    ...
    this->function.objective_gradient_hessian(ObjScale, X, Val, GX, KKTmat,
