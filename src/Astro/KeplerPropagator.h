...
struct KeplerPropagator : VectorFunction<KeplerPropagator, 7, 6,
    ASSET::DenseDerivativeModes::Analytic, ASSET::DenseDerivativeModes::Analytic> {
  ...
  inline void compute_jacobian_adjointgradient_adjointhessian_impl(
      ...
      this->propfunc.compute_jacobian_adjointgradient_adjointhessian(x, fx_, jx_, adjgrad_, adjhess_, adjvars);
  }
