...
struct TrapezoidalDefects
    ...
    void setODE(const DODE& od) {
        ...
        nzlocs.block(
            ...
            this->ode.XtUVars(), this->ode.PVars()).setOnes();

        nzlocs.block(
            Cardinals * this->ode.XtUVars(), j * this->ode.XtUVars(),
            this->ode.PVars(), this->ode.XtUVars()).setOnes();
        j = 1;
        nzlocs.block(
            j * this->ode.XtUVars(), Cardinals * this->ode.XtUVars(),
            this->ode.XtUVars(), this->ode.PVars()).setOnes();
    ...
    inline void compute_impl(const Eigen::MatrixBase<InType>& x,
        ...
        auto Impl = [&](auto & X0,auto &X1,auto &FX0, auto & FX1) {
            ...
            X0.tail(this->ode.PVars()) =
                x.tail(this->ode.PVars());

            X1.template segment<DODE::XtUV>(0,this->ode.XtUVars()) =
                x.template segment<DODE::XtUV>(this->ode.XtUVars(),
                    this->ode.XtUVars());
            X1.tail(this->ode.PVars()) =
                x.tail(this->ode.PVars());
    ...
    inline void compute_jacobian_impl(
        ...
        auto Impl = [&](auto& X0, auto& X1, auto& FX0, auto& FX1,auto & JX0,auto & JX1) {
            ...
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            jx.template block<DODE::XV, DODE::XV>(0, 0, this->ode.XVars(),
                this->ode.XVars())
                .diagonal()
                .setConstant(-One);
            jx.template block<DODE::XV, DODE::XV>(0, this->ode.XtUVars(),
            ...
            jx.template block<DODE::XV, DODE::XtUV>(0, 0, this->ode.XVars(),
                this->ode.XtUVars()) +=
                (-h / 2.0) * JX0.template block<DODE::XV, DODE::XtUV>(
                    0, 0, this->ode.XVars(), this->ode.XtUVars());

            jx.template block<DODE::XV, DODE::XtUV>(
                0, this->ode.XtUVars(), this->ode.XVars(), this->ode.XtUVars()) +=
                (-h / 2.0) * JX1.template block<DODE::XV, DODE::XtUV>(
                    0, 0, this->ode.XVars(), this->ode.XtUVars());
    ...
    template <class InType, class OutType, class JacType, class AdjGradType,
        ...
        Scalar One(1.0);
        auto Impl = [&](auto& X0, auto& X1, auto& FX0, auto& FX1, auto& JX0, auto& JX1,
            auto& AGX0,auto &AGX1,auto & HX0,auto & HX1) {
            ...
            this->ode.compute_jacobian_adjointgradient_adjointhessian(
                X0, FX0, JX0, AGX0, HX0, adjvars);
            this->ode.compute_jacobian_adjointgradient_adjointhessian(
                X1, FX1, JX1, AGX1, HX1, adjvars);
            fx = (X1.template segment<DODE::XV>(0, this->ode.XVars()) -
                X0.template segment<DODE::XV>(0, this->ode.XVars())) -
                (h / 2.0) * (FX0 + FX1);
            ...
            adjhess.template block<DODE::XtUV, DODE::XtUV>(0, 0, this->ode.XtUVars(),
                this->ode.XtUVars()) =
                (-h / 2.0) * HX0.template block<DODE::XtUV, DODE::XtUV>(
                    0, 0, this->ode.XtUVars(), this->ode.XtUVars());
            adjhess.template block<DODE::XtUV, DODE::XtUV>(
                this->ode.XtUVars(), this->ode.XtUVars(), this->ode.XtUVars(),
                this->ode.XtUVars()) =
                (-h / 2.0) * HX1.template block<DODE::XtUV, DODE::XtUV>(
                    0, 0, this->ode.XtUVars(), this->ode.XtUVars());
            ...
            HTpar.template segment<DODE::XtUV>(j* this->ode.XtUVars(),
                this->ode.XtUVars()) +=
                -AGX0.template segment<DODE::XtUV>(0, this->ode.XtUVars()) *
                One_Half;
            HTpar.tail(this->ode.PVars()) +=
                -AGX0.tail(this->ode.PVars()) * One_Half;
            ...
            HTpar.template segment<DODE::XtUV>(j* this->ode.XtUVars(),
                this->ode.XtUVars()) +=
               -AGX1.template segment<DODE::XtUV>(0, this->ode.XtUVars()) *
                One_Half;
            HTpar.tail(this->ode.PVars()) +=
                -AGX1.tail(this->ode.PVars()) * One_Half;
