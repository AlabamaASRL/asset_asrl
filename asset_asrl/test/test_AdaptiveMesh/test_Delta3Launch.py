...
class test_Delta3Launch(unittest.TestCase):
    ...
    def problem_impl(self,tmode,cmode,nsegs,errest):
        ...
        phase1.addLUNormBound("Path",[8,9,10],.9,1.1)
        ...
        phase2.addLUNormBound("Path",[8,9,10],.9,1.1)
        ...
        phase3.addLUNormBound("Path",[8,9,10],.9,1.1)
        ...
        phase4.addLUNormBound("Path",[8,9,10],.9,1.1)
    ...
    def test_FullProblem(self):
        ...
        tmodes = ["LGL3","LGL5","LGL7","Trapezoidal","LGL3"]
        nsegs  = [10   ,10   ,10   ,20,5]
