...
class PlotBase:
    ...
    def Plot3d(self,pois='all',trajs='all',bbox = False,legend = True,Arrows=False,plegend=False):
        fig = plt.figure()
        ...
        ax.set_zlabel('Z (ND)')
        plt.show()
    def Plot2d(self,pois='all',trajs='all',bbox = False,legend = True,view=[0,1],plegend=False, Arrows=False):
...
class TBPlot(PlotBase):
    def __init__(self, ode,p1name='Earth',p1col='gold'):
        PlotBase.__init__(self)
        p=40
