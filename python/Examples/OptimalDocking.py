...
##############################################################################
class RelDynModel(oc.ode_x_u.ode):
...
##############################################################################
class TorqueFree(oc.ode_x_u.ode):
...
def Form1():
    ...
    phase.addValueObjective("Back",20,.1)
    ...
    #phase.optimizer.PDStepStrategy = solvs.PDStepStrategies.AllMinimum
    phase.optimizer.SoeMode = solvs.AlgorithmModes.OPTNO
...
def Form2():
    ...
    TargetTab  = oc.LGLInterpTable(ode_torquefree,7,0,Tmodes.LGL3,TargetTraj,2000)
