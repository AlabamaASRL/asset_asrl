...
######################################################################
phase = ode.phase(Tmodes.LGL3,IG,900)
...
Tab      = oc.LGLInterpTable(ode,6,3,Tmodes.LGL3,TrajConv,900)
...
plt.plot(TT2[0],TT2[1],label="Optimal Trajectory Reintegrated")


plt.scatter(IGT[0][-1],IGT[1][-1],marker="*",zorder=500)
plt.scatter(TT[0][-1],TT[1][-1],marker="*",zorder=500)
plt.scatter(TT2[0][-1],TT2[1][-1],marker="*",zorder=500)
