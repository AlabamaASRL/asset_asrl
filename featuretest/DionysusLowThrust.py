...
if __name__ == "__main__":
    ...
    U2N = ( TT[10] - min(TT[10]))/(1+max(TT[10]) - min(TT[10]))
    
    UU = (TT[8]**2+TT[9]**2+TT[10]**2)**.5
    
    U2N = ( UU - min(UU))/(1+max(UU) - min(UU))


    j0 = oc.jump_function(TT[7],U0N,TT[7][1:-1],5)
    j1 = oc.jump_function(TT[7],U1N,TT[7][1:-1],5)
    j2 = oc.jump_function(TT[7]/TT[7][-1],U2N,TT[7][1:-1]/TT[7][-1],5)
    ...
    axs[0].plot(TT[7][1:-1],abs(j0))
    axs[0].plot(TT[7][1:-1],abs(j1))
    axs[0].plot(TT[7][1:-1],abs(j2))
