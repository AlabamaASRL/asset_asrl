...
if __name__ == "__main__":
    ...
    phase = ode.phase('CentralShooting', TrajIG, 64)
    phase.NewShooter = True
    phase.integrator.EnableVectorization = True
    phase.integrator.setAbsTol(1.0e-10)
    
    phase.addBoundaryValue("Front", range(0, 7), X0)
    phase.addLUNormBound("Path",[7,8,9], .001, 1, 1.0)
