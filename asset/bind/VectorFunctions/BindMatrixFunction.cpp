#include <bind/VectorFunctions/BindMatrixFunction.h>

void ASSET::BindMatrixFunction(py::module& m) {
  ...
  ColMat.def("transpose", [](const colmattype& m1) { return rowmattype(m1, m1.MatrixCols, m1.MatrixRows); });
  ...
  RowMat.def("transpose", [](const rowmattype& m1) { return colmattype(m1, m1.MatrixCols, m1.MatrixRows); });
